...
| TEST-CONTRACT-001 | Schema meta/positive/negative、版本、UTC/duration/reference、isolation 与 round-trip | P0-P1 | Existing schema suite + [`test_unit_conversion_registry.py`](../../backend/tests/contract/test_unit_conversion_registry.py) + [`test_import_validation.py`](../../backend/tests/contract/test_import_validation.py)；preserved artifacts/additive `2.2.0` Error/report contract与Problem v1 regression formed |
...
| TEST-SNAPSHOT-REPLAY-001 | Snapshot canonical bytes/hash/ID、immutability与 repository replay | P1 | [`test_snapshot_builder.py`](../../backend/tests/unit/test_snapshot_builder.py) + [`test_snapshot_properties.py`](../../backend/tests/property/test_snapshot_properties.py) + [`test_snapshot_repository.py`](../../backend/tests/integration/test_snapshot_repository.py) formed / TASK-P1-08；provider run `32310098594` PASS |
| TEST-PROBLEM-REPLAY-001 | Solver-neutral Problem builder/bytes/hash deterministic replay | P1 | [`test_planning_problem_builder.py`](../../backend/tests/unit/test_planning_problem_builder.py) + [`test_planning_problem_properties.py`](../../backend/tests/property/test_planning_problem_properties.py) + [`test_p1_problem_replay.py`](../../backend/tests/golden/test_p1_problem_replay.py) formed / TASK-P1-09；provider run `32315513504` PASS |
...
| TEST-SCENARIO-REPLAY | Scenario/Profile/Generator/seed 重放 | P0-P2 | empty Import [`test_simulation_contracts.py`](../../backend/tests/simulation/test_simulation_contracts.py) + committed P0 fixture + P1 generated Import v2 [`test_p1_synthetic_generator.py`](../../backend/tests/simulation/test_p1_synthetic_generator.py) bytes/hash/version/layer replay formed；Solver replay PLANNED |
| TEST-SIM-ISOLATION | Synthetic/Production 隔离 | P0-P1 | [`test_simulation_contracts.py`](../../backend/tests/simulation/test_simulation_contracts.py) + P1 generator Production/unsupported/no-Planning rejection + Snapshot repository plane guard formed；separate DB/API/publish guards PLANNED |
...
当前聚焦suite为`18 passed`，no-import单测为`1 passed`，Ruff/Pyright均0问题；machine check为7/7 PASS、16 collections、49 records、hash `sha256:24a74b4f43b0ba42ed458983e0c4776613911924ae5250d9df8ae9e4f14cb1c4`。Provider CI仍待implementation commit后核验，故只记录本地evidence；TEST-SCENARIO-REPLAY/TEST-SIM-ISOLATION获得P1 generator slice，但TEST-P1-COMMON-INGRESS、P2 TEST-PROPERTY/Solver/Benchmark仍`PLANNED`。Test ID和registry表结构不变，`registry_version`保持`1.0.0`。
