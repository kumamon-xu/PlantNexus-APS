...
本清单列出当前仓库已经实际存在的 Markdown 文档。P0退出门已通过并归档为completed；P1已获授权并形成12张Task Card，TASK-P1-01～07已完成，TASK-P1-08为`in_progress`，TASK-P1-09～12仍为`planned`。产品API与Production Runbook正文尚未形成并继续由相应索引登记。
...
| [tasks/P1/TASK-P1-08-immutable-snapshot-and-hash.md](../tasks/P1/TASK-P1-08-immutable-snapshot-and-hash.md) | TASK-P1-08 | in_progress | Immutable PlanningSnapshot and Hash |
...
TASK-P1-08未新增Markdown路径，清单继续覆盖124份`docs/**/*.md`；新增内容仅为限定Snapshot Python、migration和test文件，`build/traceability/TASK-P1-08-report.json`保持ignored且不进入清单。当前Task为`in_progress`，implementation/provider/evidence closure完成后再同步最终状态，不预填外部PASS。
