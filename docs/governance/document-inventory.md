...
本清单列出当前仓库已经实际存在的 Markdown 文档。P0退出门已通过并归档为completed；P1已获授权并形成12张Task Card，TASK-P1-01～03已完成，TASK-P1-04为`in_progress`，TASK-P1-05～12仍为`planned`。产品API与Production Runbook正文尚未形成并继续由相应索引登记。
...
| [tasks/P1/TASK-P1-04-csv-excel-reference-adapter.md](../tasks/P1/TASK-P1-04-csv-excel-reference-adapter.md) | TASK-P1-04 | in_progress | CSV Excel and Formal Reference Adapter |
...
TASK-P1-02/03均未新增Markdown路径，因此清单行数仍为124；TASK-P1-04也不计划新增Markdown路径，只会更新已登记文档与新增限定的Python/test文件。其Diff base与范围已在Task Card固定，文档清单不把代码/lock/临时报告伪装成Markdown条目。
