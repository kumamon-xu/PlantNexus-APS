...
| REQ-009 | REQ | `docs/architecture/provenance-and-versioning.md` | P0-P4 / TASK-P0-01、TASK-P0-02、TASK-P0-03、TASK-P0-08 | Repository/schema provenance + [`build metadata/health/log`](../../backend/app/infrastructure/config.py) engineering slice formed；real source/Snapshot/Problem/Solver/export manifest/audit PLANNED |
...
| NFR-PER-001 | NFR | `docs/simulation/performance-gates.md`、`docs/quality/benchmark-regression.md` | P0-P7 / TASK-P0-08 | PR workflow hook formed but no runner/Solver result；production threshold remains OPEN-012 |
...
| ENG-ARCH-001 | ENG | `docs/architecture/repository-layout.md`、`docs/architecture/module-boundaries.md`、`docs/adr/ADR-0002-modular-monolith-and-solver-worker.md` | P0 / TASK-P0-01、TASK-P0-08 | Repository build + health API/Celery process/config skeleton formed；business/Solver Worker and distributed behavior PLANNED |
...
| ENG-VER-001 | ENG | `docs/architecture/provenance-and-versioning.md`、`docs/contracts/schema-versioning.md`、`docs/architecture/technology-stack.md` | P0-P7 / TASK-P0-01～TASK-P0-08 | code/spec/schema `1.2.0` preserved + exact runtime/lock/build commit metadata formed；Solver/production artifact versioning PLANNED |
