...
当前 schema set 为additive `2.2.0`。`CONTRACT_V1/V2/V3`表示机器可验证的合同已形成，不表示Snapshot/Problem builder、KPI计算、ScheduleValidator、状态持久化或业务动作已完成。`1.0.0/1.1.0/1.2.0/2.0.0/2.1.0` artifact均保留，未被原地覆盖。
