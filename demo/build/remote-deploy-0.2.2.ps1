...
$zipPath = 'C:\Users\Himmler\PlantNexus-CNC-Demo-Windows-x64-0.2.2.zip'
$deployRoot = 'W:\PlantNexus-CNC-Demo'
$stageRoot = 'W:\PlantNexus-CNC-Demo-0.2.2-stage'
$expandedRoot = Join-Path $stageRoot 'PlantNexus-CNC-Demo-Windows-x64-0.2.2'
$backupRoot = 'W:\PlantNexus-CNC-Demo-backup-' + (Get-Date -Format 'yyyyMMdd-HHmmss')
$expectedSha = 'c2cf612071bc38ce8e84925243b60f35b19011a3cba36e09f09bed336f1ed629'
...
$ruleName = 'PlantNexus CNC Demo 4174 - Private LAN'
...
& (Join-Path $deployRoot 'PlantNexusCncDemo.exe') status | Out-Host
if ($LASTEXITCODE -ne 0) {
    throw '新演示服务状态检查失败。'
}
...
[pscustomobject]@{
    ...
    url = 'http://192.168.1.249:4174/demo/'
