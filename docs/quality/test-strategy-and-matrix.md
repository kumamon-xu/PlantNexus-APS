...
| TEST-EXPORT-JOB-001 | ExportJob transition、package integrity、atomic/idempotent export与失败恢复 | P3 | persistence slice provider-verified / TASK-P3-03；business/package slice provider-verified / TASK-P3-09 |
| TEST-AUDIT-TRAIL-001 | append-only actor/reason/correlation/before-after/version audit完整性 | P3 | storage/command/decision/publication/export success/DENIED、redaction、rollback/replay provider-verified / TASK-P3-03～09；API completeness PLANNED / P3-10 |
