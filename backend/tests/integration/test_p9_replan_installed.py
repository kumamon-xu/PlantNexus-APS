...
def test_replan_contracts_from_installed_wheel(
    ...
    installed_test = tmp_path / "test_p9_replan.py"
    installed_test.write_bytes(
        (root / "backend/tests/integration/test_p9_replan.py").read_bytes()
    )
    ...
    report = root / "build/validation/P9-07"
