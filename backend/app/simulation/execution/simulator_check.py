...
_P9_REPLAN_SCHEMA_METADATA_PYPROJECT_SHA256 = "a6f6f93739414a5f4cf43963c9493c8563dc84e295a1c345eb6d4d359c66d0e6"
_P8_RUNTIME_SDK_PACKAGE_PYPROJECT_SHA256 = (
        ...
        accepted = (
            {
                ...
                _P8_RELEASE_METADATA_PYPROJECT_SHA256,
                _P8_RUNTIME_SDK_PACKAGE_PYPROJECT_SHA256,
            _P9_REPLAN_SCHEMA_METADATA_PYPROJECT_SHA256,
            }
            if relative == "pyproject.toml"
            else {expected}
        )
        _ensure(digest in accepted, f"frozen boundary changed: {relative}")
