...
$zipPath = 'C:\Users\Himmler\PlantNexus-CNC-Demo-Windows-x64-0.2.4.zip'
$deployRoot = 'W:\PlantNexus-CNC-Demo'
$stageRoot = 'W:\PlantNexus-CNC-Demo-0.2.4-stage'
$expandedRoot = Join-Path $stageRoot 'PlantNexus-CNC-Demo-Windows-x64-0.2.4'
$backupRoot = 'W:\PlantNexus-CNC-Demo-backup-' + (Get-Date -Format 'yyyyMMdd-HHmmss')
$expectedSha = '84cfd777b2eed5c01a83ed494ac83d33776a49e741bf8c017e587f7c591bd2c6'
...
try {
    ...
    if (Test-Path -LiteralPath $oldRuntime -PathType Container) {
