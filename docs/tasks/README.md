...
| [TASK-P2-09](P2/TASK-P2-09-golden-scenario-property-integration.md) | Golden/scenario/property integration | P2-04～08 | `in_progress` |
...
TASK-P2-00～08已`done`。P2-03的Diff base固定为`f73f8c90af94d3c9b05ecc10b6c999594a3b7d66`且ADR-0011先于dependency变更接受；P2-04～08的implementation及exact provider evidence均已闭环。TASK-P2-09已获明确授权并以`15c298f343a47db2a922544944ff5e02e4ca72d9`为Diff base进入`in_progress`；P2-10～14继续`planned`且未获授权。
