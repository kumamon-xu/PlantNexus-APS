...
本清单列出当前仓库已经实际存在的Markdown文档。P0～P2均已归档为completed；P2 Exit Gate=`READY`且用户已批准transition。P3现为active，TASK-P3-00～11均已done，P3-12～15为planned。P3人类可审计API/Frontend规范、workspace机器carrier、有界持久化/生命周期/read/command/decision/publication、ExportJob/standard package、HTTP API与P3-11 read-only Frontend及其exact provider evidence已形成；Production Runbook正文仍未形成。
