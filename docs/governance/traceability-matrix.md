...
| NFR-COR-001 | NFR | `docs/planning/constraint-catalog.md`、`docs/planning/schedule-validator.md` | P0-P2 / TASK-P0-04、TASK-P0-06、TASK-P0-07 | C-001～C-011 formula/violation/v2 contract + `SIM-MINIMAL-001` independent positive calculation/hard count 0 formed；reusable evaluator/mutation rejection PLANNED |
...
| ENG-VAL-001 | ENG | `docs/planning/schedule-validator.md`、`docs/adr/ADR-0005-independent-schedule-validator.md` | P0-P2 / TASK-P0-04 contract、TASK-P0-06 positive、TASK-P0-07 mutation | Rule metadata/completeness + loader no Planning/Solver import + test-local positive formulas formed；reusable evaluator/Mutation tests PLANNED |
