...
Provider payload只包含safe model、manifest、sanitized replay/report，不包含raw source、dataset bundle/rows或labels。8个baseline estimate自身没有confidence和formal evaluation authority，不是`DurationPrediction` carrier，不进入runtime、Planning或Production。P6-02 Schema/sample、P6-03 source/dataset、dependency lock、migration/state及routing/resource/hard-constraint/weights均不变；P6-04完成没有自动启动P6-05，后者经独立授权形成的offline Gate见本页顶部。能力仍无runtime，OPEN-010/011/014/015继续OPEN。
