...
|---|---|---|
| RT-SPACER-3 | 简单隔套 | 下料 → CNC 车削 → 三坐标检测 |
| RT-PLATE-4 | 精密安装板 | 下料 → 三轴/四轴铣削 → 去毛刺清洗 → 三坐标检测 |
| RT-BRACKET-4 | 复杂支架 | 下料 → 三轴/五轴铣削 → 去毛刺清洗 → 三坐标检测 |
| RT-SHAFT-5 | 精密轴 | 下料 → 粗车 → 精车/车铣 → 外圆磨 → 三坐标检测 |
| RT-SLEEVE-5 | 薄壁套 | 下料 → 外圆车削 → 内孔车削 → 去毛刺清洗 → 三坐标检测 |
| RT-HOUSING-6 | 阀体 / 壳体 | 下料 → 粗铣 → 孔系加工 → 五轴精加工 → 去毛刺清洗 → 三坐标检测 |
