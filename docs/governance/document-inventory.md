...
本清单列出当前仓库已经实际存在的Markdown文档。P0/P1均已归档为completed；P2现为active，TASK-P2-00～11已done，TASK-P2-12已获授权并为in_progress。P2-13/14仍为planned且未获启动授权。产品API与Production Runbook正文尚未形成并继续由相应索引登记。
...
| [tasks/P2/TASK-P2-12-benchmark-runner-xs-s-m.md](../tasks/P2/TASK-P2-12-benchmark-runner-xs-s-m.md) | TASK-P2-12 | in_progress | BenchmarkRunner and XS S M Profiles |
