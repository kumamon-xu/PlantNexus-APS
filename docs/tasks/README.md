...
| [TASK-P2-12](P2/TASK-P2-12-benchmark-runner-xs-s-m.md) | BenchmarkRunner与XS/S/M | P2-08～11 | `in_progress` |
...
TASK-P2-00～11已`done`。P2-03的Diff base固定为`f73f8c90af94d3c9b05ecc10b6c999594a3b7d66`且ADR-0011先于dependency变更接受；P2-04～11的implementation及exact provider evidence均已闭环。TASK-P2-12已获授权并为`in_progress`；P2-13/14继续`planned`且未获授权。
