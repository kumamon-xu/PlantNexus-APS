...
| TEST-CONTRACT-001 | Schema meta/positive/negative、版本、UTC/duration/reference、isolation 与 round-trip | P0-P2 | Existing schema suite + [`test_p2_output_contracts.py`](../../backend/tests/contract/test_p2_output_contracts.py)；preserved artifacts/additive `2.5.0` KPI/manifest contract与cross-document negatives formed |
