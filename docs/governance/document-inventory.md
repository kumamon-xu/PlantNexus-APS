...
本清单列出当前仓库已经实际存在的 Markdown 文档。P0退出门已通过并归档为completed；P1已获授权并形成12张Task Card，TASK-P1-01～03已完成，TASK-P1-04～12仍为`planned`。产品API与Production Runbook正文尚未形成并继续由相应索引登记。
...
TASK-P1-02/03均未新增Markdown路径，因此清单行数仍为124；TASK-P1-03新增Python/migration/test路径由Task evidence与追踪矩阵记录，不伪装成文档清单条目。下一项TASK-P1-04尚未启动。
