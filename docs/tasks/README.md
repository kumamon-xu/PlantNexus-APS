...
| [TASK-P1-07](P1/TASK-P1-07-deterministic-order-expansion.md) | Deterministic Order/Lot/Operation expansion | P1-06 | `in_progress` |
...
TASK-P1-05已以implementation commit `d52aa62d36e8d89eba318cb5fc586311680e030f`及GitHub Actions run `32252308695`完成；TASK-P1-06也已以implementation commit `c1ac1077fdd92e012f4050f30bab2aec4638f6ec`及run `32257767495`完成。TASK-P1-07以`97728521e187f9f50715de4b04a09098bef62ddf`为Diff base形成本地implementation candidate，14 targeted/219 full tests与45-path治理均PASS，仍待provider核验而保持`in_progress`；P1-08不会自动启动，P1-12即使审计`READY`也不自动进入P2。
