...
Start gate: P2-01～12全部`done`且各自exact provider artifact可取；固定clean implementation baseline、Gate config、scenario/profile versions和Diff base。
