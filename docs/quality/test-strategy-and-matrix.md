...
| TEST-WORKSPACE-READ-MODEL-001 | Gantt、Resource Load、Order View与Version Comparison lineage/KPI一致性 | P3 | TASK-P3-05 provider-verified；TASK-P3-10 HTTP carrier/delegation provider-verified；P3-12 visualization consumer LOCAL_PASS / provider pending |
...
| TEST-WORKSPACE-FRONTEND-001 | read/action UI、状态可见性、accessibility与no-client-authority E2E | P3 | P3-11 read-only unit/component slice PROVIDER_VERIFIED；P3-12 visualization/browser slice LOCAL_PASS / provider pending；P3-13 actions PLANNED |
