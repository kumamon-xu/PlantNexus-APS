...
P1当前状态：[`P1 — Data & Snapshot`](P1-data-and-snapshot.md)为`active`，已创建TASK-P1-01～12；TASK-P1-01/02=`done`、TASK-P1-03=`in_progress`、TASK-P1-04～12=`planned`，最后一项是P1 Exit Gate Audit。P1-02 schema set`2.0.0`合同已通过本地验收、commit与provider CI；当前只实施Raw Staging，不实施后续pipeline或P2。
