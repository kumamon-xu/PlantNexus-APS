...
| REQ-004 | REQ | `docs/architecture/end-to-end-planning-flow.md`、`docs/planning/constraint-catalog.md` | P2 / TASK-P0-04（contract） | [`constraint-rule-sheet.v1`](../../schemas/rules/constraint-rule-sheet.v1.yaml) + [`TEST-RULE-SHEET-001`](../../backend/tests/contract/test_rule_contracts.py) formed；solver implementation PLANNED |
| REQ-005 | REQ | `docs/planning/schedule-validator.md` | P0-P2 / TASK-P0-04 contract、TASK-P0-07 mutation | [`validation-report.v2`](../../schemas/json/validation-report.v2.schema.json) + rule sheet/completeness test formed；candidate evaluator/mutation PASS PLANNED |
...
| REQ-011 | REQ | `docs/simulation/synthetic-generator-and-determinism.md` | P0-P1 / TASK-P0-05 | [`factory-profile.v1`](../../schemas/scenario/factory-profile.schema.json) + seven-layer [`Generator Protocol`](../../backend/app/simulation/generators/contracts.py) + empty Import [`TEST-SCENARIO-REPLAY`](../../backend/tests/simulation/test_simulation_contracts.py) formed；non-empty generator PLANNED |
| REQ-012 | REQ | `docs/simulation/scenario-spec-and-provenance.md` | P0-P2 / TASK-P0-05、TASK-P0-06 | [`scenario-spec.v1`](../../schemas/scenario/scenario-spec.schema.json) + [`scenario-manifest.v1`](../../schemas/scenario/scenario-manifest.schema.json) + replay test formed；formal Scenario/Fixture PLANNED |
...
| NFR-COR-001 | NFR | `docs/planning/constraint-catalog.md`、`docs/planning/schedule-validator.md` | P0-P2 / TASK-P0-04、TASK-P0-07 | C-001～C-011 formula/violation/v2 report contract formed；real schedule validation evidence PLANNED |
| NFR-DET-001 | NFR | `docs/contracts/planning-snapshot.md`、`docs/contracts/planning-problem.md`、`docs/simulation/synthetic-generator-and-determinism.md` | P0-P1 / TASK-P0-03、TASK-P0-05、TASK-P0-06 | Strict UTC/duration + empty Import canonical hash/named seed [`TEST-SCENARIO-REPLAY`](../../backend/tests/simulation/test_simulation_contracts.py) formed；non-empty Scenario/Snapshot/Problem replay PLANNED |
| NFR-TRC-001 | NFR | `docs/architecture/provenance-and-versioning.md`、`docs/governance/traceability-rules.md` | P0-P4 / TASK-P0-01、TASK-P0-02、TASK-P0-03、TASK-P0-05 | Repository/schema trace + [`scenario-manifest.v1`](../../schemas/scenario/scenario-manifest.schema.json) formed；production sources/code commit/run/export audit PLANNED |
...
| ENG-VAL-001 | ENG | `docs/planning/schedule-validator.md`、`docs/adr/ADR-0005-independent-schedule-validator.md` | P0-P2 / TASK-P0-04 contract、TASK-P0-07 mutation | Rule metadata/completeness + no backend/OR-Tools import check formed；evaluator/Mutation tests PLANNED |
| ENG-ERR-001 | ENG | `docs/domain/error-model.md`、`docs/planning/infeasibility-diagnostics.md` | P0-P2 / TASK-P0-04 | [`error.v2`](../../schemas/json/error.v2.schema.json) + 19-code registry + TEST-ERROR-MAPPING-001 formed；HTTP mapping PLANNED |
| ENG-VER-001 | ENG | `docs/architecture/provenance-and-versioning.md`、`docs/contracts/schema-versioning.md`、`docs/architecture/technology-stack.md` | P0-P7 / TASK-P0-01～TASK-P0-05 | code/spec lock PASS；schema set `1.2.0` in [`pyproject`](../../pyproject.toml)、[`package metadata`](../../backend/app/__init__.py)、[`data dictionary`](../../schemas/data_dictionary.yaml)，historical artifacts preserved + Simulation versions/replay formed |
