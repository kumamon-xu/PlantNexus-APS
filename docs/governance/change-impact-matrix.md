...
TASK-P3-10实际命中7行：`IMPACT-API/STATE/INFRA/TESTS/PHASE/GOVERNANCE-REGISTRY/DOCS`。Diff base=`f71c4a5a11a3fac0e203e2e92198c26124755927`；API与three test classes、health/CI contract、single required workflow step及逐字文档allow-list可变，Schema/sample/rules、migration、dependency/lock、domain/application/repository/exporter/job、Frontend/external/P4零差异。本地API 8/8、41 focused、603 full、full governance与Task report均PASS；exact provider仍待复验，因此Task保持`in_progress`且不启动P3-11。
