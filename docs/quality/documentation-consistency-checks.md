...
Full docs、Task diff、`git diff --check`、forbidden-root、machine report与全部local validation须在implementation和closure各运行。Provider artifact必须精确绑定Task/SHA/Diff base、八rows、full check set和0 issues。当前full治理实际为165 docs、30 roots/trace rows、48 Test IDs、15 OPEN、13 SIM assumptions、13 risks、53 Tasks；Task diff实际为45 paths（0 committed-range、45 working-tree union）、8 rows、19 checks、0 issues。Provider前TASK-P3-04保持`in_progress`，P3-05不得启动。
