...
| [TASK-P1-03](P1/TASK-P1-03-raw-staging-and-import-provenance.md) | Raw Staging、provenance、idempotent persistence | P1-02 | `done` |
| [TASK-P1-04](P1/TASK-P1-04-csv-excel-reference-adapter.md) | CSV、Excel与ReferenceFileAdapter v1 | P1-02/03 | `done` |
...
| [TASK-P1-10](P1/TASK-P1-10-synthetic-generator-records.md) | 七层 Synthetic Generator非空 canonical records | P1-02/05/06/07 | `in_progress` |
...
TASK-P1-05/06/07/08/09已分别以implementation commit `d52aa62d36e8d89eba318cb5fc586311680e030f`、`c1ac1077fdd92e012f4050f30bab2aec4638f6ec`、`5a3dbc14c12a107abf4052cca935e3ef59009d3d`、`72670d18a29c9a10cb70f7a263c981a2b660e0ee`、`e8c59547857d2eeace1c9f8b453a5a294cca5ef7`及GitHub Actions run `32252308695`、`32257767495`、`32265257468`、`32310098594`、`32315513504`完成。P1-10现以immutable Diff base `11c6ca97882a3be5bf6eb25bab84f69d1dfe469c`保持`in_progress`；本地49-record generator replay、262项全仓回归、7/7 machine checks和52-path/7-row治理均PASS，待implementation commit与精确provider evidence闭环后才可标记`done`。P1-11不得提前启动，P1-12即使审计`READY`也不自动进入P2。
